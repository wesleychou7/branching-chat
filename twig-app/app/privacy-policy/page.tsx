...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BranchingChat.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BranchingChat, accessible from{" "}
            <a
              href="https://www.branchingchat.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.branchingchat.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: wesleychou9851@gmail.com</li>
      </ul>
    </div>
  );
}
